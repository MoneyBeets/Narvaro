 ...
 */
public abstract class DefaultConnectionProvider implements ConnectionProvider {
    ...
    public Connection getConnection() throws SQLException {
        return new Connection(cpds.getConnection(), getPoolName(), getDatabaseType());
    }
    ...
    /**
     * Returns the database pool name used to identify
     * which pool this connection originated from.
     * 
    ...
    /**
     * Sets the database pool name used to identify
     * which pool this connection originated from.
     * 
    ...
    /**
     * Returns the database name used to make database connections
     * as part of the JDBC connection URL.
     * 
    ...
    /**
     * Sets the database name used to make database connections
     * as part of the JDBC connection URL. The name is set to
     * lowercase.
     * 
     * @param dbType The database type.
     */
    public void setDbName(final DatabaseType dbType) {
        this.dbName = dbType.toString().toLowerCase();
    }
